...
Script to delete multiple VM Servers in K5
...
$server = Get-K5Resources -token $token -type servers -useproxy | out-gridview -Title "Select a server or servers to delete and click OK" -PassThru
